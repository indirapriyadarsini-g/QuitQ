    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
       http.csrf(AbstractHttpConfigurer::disable)
               .authorizeHttpRequests(auth -> auth
            		   ...
            		   .requestMatchers("/customer/my-cart").permitAll()
            		   .requestMatchers("/customer/my-wishlist").permitAll()
            		   .requestMatchers("customer/order-now/{pId}").permitAll()
            		   .requestMatchers("customer/order").permitAll()
            		   .requestMatchers("customer/add-to-cart/{pId}").permitAll()
            		   .requestMatchers("customer/add-to-wishlist/{pId}").permitAll()
