    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
       http.csrf(AbstractHttpConfigurer::disable)
               .authorizeHttpRequests(auth -> auth
            		   ...
            		   .requestMatchers("/customer/view-my-wishlist").hasRole(RoleType.CUSTOMER.toString())	
            		   ...
            		   .requestMatchers("customer/remove-from-order/{cpId}").hasRole(RoleType.CUSTOMER.toString())
            		   .requestMatchers("customer/add-count-in-cart/").hasRole(RoleType.CUSTOMER.toString())
            		   .requestMatchers("customer/sub-count-in-cart/").hasRole(RoleType.CUSTOMER.toString())
            		   .requestMatchers("customer/add-count-in-order/").hasRole(RoleType.CUSTOMER.toString())
            		   .requestMatchers("customer/sub-count-in-order/").hasRole(RoleType.CUSTOMER.toString())
